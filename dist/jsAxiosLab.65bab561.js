...
var API_KEY = 'live_A77lKFuzZrWTLli2d9J5SCMpuX0YD56lmQpyAk7IrG4pu7re49nRFlL1sPVA9sg6';
  ...
  _initialLoad = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          option = document.createElement("option"); //option.value=element.id;
...
function _selectFunction() {
  _selectFunction = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var selectedOption, selectedName, selectedBreedId, response, jsonData, infoData;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 7;
          return fetch("https://api.thecatapi.com/v1/images/search?limit=15&breed_ids=".concat(selectedBreedId), {
            method: 'GET',
            headers: {
              'x-api-key': API_KEY
            }
...
},{"bootstrap":"node_modules/bootstrap/dist/js/bootstrap.esm.js","./index.js":"index.js"}],"jsAxiosLab.js":[function(require,module,exports) {
"use strict";
...
// Step 0: Store your API key here for reference and easy access.
var API_KEY = 'live_A77lKFuzZrWTLli2d9J5SCMpuX0YD56lmQpyAk7IrG4pu7re49nRFlL1sPVA9sg6';
_axios.default.defaults.headers.common['Authorization'] = API_KEY;
 ...
 */
function _selectFunction() {
  _selectFunction = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var selectedOption, selectedName, selectedBreedId, jsonData, arrOfSelectedData, infoData, imgAlt;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
        ...
        case 12:
          arrOfSelectedData = _context3.sent;
          infoData = selectedName;
          console.log(infoData);
          Carousel.clear();
          //   let url2;
          ...
          infoDump.innerHTML = "<p>Scroll to see ".concat(jsonData.data.length, " images of ").concat(infoData, " Cat Breed </p>");
...
_axios.default.interceptors.request.use(function (request) {
  ...
  console.log("Request start time: " + request.metadata.startTime);
  return request;
});
_axios.default.interceptors.response.use(function (response) {
  response.config.metadata.endTime = new Date().getTime();
  console.log("Request end time: " + request.config.metadata.endTime);
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","jsAxiosLab.js"], null)
//# sourceMappingURL=/jsAxiosLab.65bab561.js.map